...
func main() {
	rootDir := "/home/dan/Code/012-Ultimate_Go/05-Concurrency/20-Exercise_Converting_sequential_algorithms_to_concurrent/taxi_concurrent/taxi" // Change to where unzipped taxi_concurrent-sha256.zip
